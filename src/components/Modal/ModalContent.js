                    ...
                    {content && (
                        <div className={classes.paper}>
                            <div className="ModalContent">
                                <img 
                                    className="ModalContent_portrait"
                                    src={content.poster_path?`${img_500}/${content.poster_path}`:unavailable} 
                                    alt={content.name || content.title} 
                                />
                                <img 
                                    className="ModalContent_landscape"
                                    src={content.poster_path?`${img_500}/${content.poster_path}`:unavailable} 
                                    alt={content.name || content.title} 
                                />
                                <div className="ModalContent_about">
                                    <span className="ModalContent_title">
                                    ...
                                    <span className="ModalContent_description">
                                        {content.overview}
                                    </span>
                                    <div>
